let bionicle = {
    ...
    review1: "A captivating toy line and storytelling experience that ignited the imaginations of many with its intricate world-building and unique characters. -- Every 90's kid",
    review2: "",
    review3: "",
...
let riskofrain = {
    ...
    trailer: "https://www.youtube.com/watch?v=Cia3haHicFU",
    number: "1"
}
...
let outerwilds = {
    ...
    developedby: "Mobius Digital",
    logo: "outerwildslogo.png",
    review1: "Outer Wilds is a love letter to the wonders of discovery and the human urge to explore. From the second you boot up the game, it provides you with everything you need to complete it, you just lack one single thing: The knowledge on how to put the pieces together. How you get that knowledge is completely up to the player. The game does not force a mission on you – the minute you get your three-fingered hands on the launch codes for your ship you’re free to go wherever. The game lets you explore at your own pace, and I think that’s what makes it so beautiful. The game becomes more existential the longer you play it and its ending hits you like a brick. I still remember the night where I got to it as clearly as if it happened just a few hours ago. It tore the way in which I saw life up to this point into pieces and reformed it like some sort of big bang. It made me feel incredibly tiny compared to the bigger picture that is the universe and yet managed to make me feel just as important. I could ramble about this game for hours, but I think it’s best to jump into it completely blind, the experience is best that way. The universe is a beautiful place, death is inevitable, play Outer Wilds. -- Feldspar",
    review2: "Great game with amazing storyline -- Hatchling",
    review3: "The sun is capable of hating you -- Chert",
...
let einhaender = {
    ...
    trailer: "https://www.youtube.com/watch?v=xTB4ZLvOPqs",
    number: "3"
}
...
let ultrakill = {
    ...
    review1: "no sex :( -- Gabriel (Archangel)",
    review2: "NO!! HE IS WRONG!!! THERE IS SEX -- V2",
    review3: "When Gabriel says I'm going to Ultrakill you, I cried emotionally for three weeks -- V1",
    ...
    trailer: "https://www.youtube.com/watch?v=Pw63IVgYLDc",
    number: "4"
}

let warhammer40k = {
    description: "Warhammer 40,000 is a miniature wargame produced by Games Workshop. It is the most popular miniature wargame in the world, and is particularly popular in the United Kingdom. The first edition of the rulebook was published in September 1987, and the ninth and current edition was released in July 2020",
    developedby: "Games Workshop",
    logo: "warhammer40klogo.png",
    review1: "A vast and grimdark science fiction universe that immerses players in a war-torn future where epic battles, intricate lore, and the struggle for survival reign supreme. -- The God Emperor",
    review2: "",
    review3: "",
    ...
    trailer: "https://www.youtube.com/watch?v=KyxyQ0tixFk",
    number: "5"
}

let deeprockgalactic = {
    description: "Deep Rock Galactic is a cooperative first-person shooter video game developed by Danish studio Ghost Ship Games and published by Coffee Stain Publishing. Deep Rock Galactic was fully released on May 13, 2020 for Microsoft Windows and Xbox One after spending two years in early access. The game was later released for PlayStation 4 and PlayStation 5 in January 2022, and for Xbox Series X/S in September 2022.",
    developedby: "Ghost Ship Games",
    logo: "deeprockgalacticlogo.png",
    review1: "A cooperative mining and shooting game that offers a thrilling blend of teamwork, exploration, and intense action against hordes of alien creatures in procedurally generated caves. -- A working dwarf",
    review2: "",
    review3: "",
...
let deadspace = {
    ...
    trailer: "https://www.youtube.com/watch?v=RYaJCmJgb9A",
    number: "7"
}

let digimon = {
    description: "Digimon (Japanese: デジモン, Hepburn: Dejimon, branded as Digimon: Digital Monsters, stylized as DIGIMON), short for Digital Monsters (デジタルモンスター Dejitaru Monsutā), is a Japanese media franchise encompassing virtual pet toys, anime, manga, video games, films and a trading card game. The franchise focuses on the eponymous creatures, who inhabit a Digital World, a parallel universe that originated from Earth's various communication networks",
    developedby: "Bandai",
    ...
    trailer: "https://www.youtube.com/watch?v=iHJz0Y1_qlE",
    number: "8"
}

let planetes = {
    description: "Planetes (Japanese: プラネテス, Puranetesu, Greek: Πλάνητες Planētes, Wanderers) is a Japanese hard science fiction manga written and illustrated by Makoto Yukimura. It was serialized in Kodansha's seinen manga magazine Morning between January 1999 to January 2004, with its chapters collected into four tankōbon volumes. It was adapted into a 26-episode anime television series by Sunrise, which was broadcast on NHK from October 2003 through April 2004. The story revolves around the crew of a space debris collection craft in the year 2075.",
    developedby: "Makoto Yukimura",
    ...
    trailer: "https://www.youtube.com/watch?v=meAYYH-DYKc",
    number: "9"
}

let godzilla = {
    description: "Godzilla (/ɡɒdˈzɪlə/ god-ZIL-ə; Japanese: ゴジラ, romanized: Gojira, pronounced [ɡoꜜʑiɾa] is a fictional monster, or kaiju, in Toho Co., Ltd.'s eponymous media franchise. Debuting in the self-titled 1954 film, directed and co-written by Ishirō Honda; the character has since become an international pop culture icon, appearing in various media: 33 Japanese films produced by Toho, five American films and numerous video games, novels, comic books and television shows. Godzilla has been dubbed the King of the Monsters, an epithet first used in Godzilla, King of the Monsters! (1956), the American localization of the 1954 film.",
    developedby: "Tomoyuki Tanaka, Eiji Tsuburaya, Ishirō Honda",
    logo: "godzillalogo.png",
    review1: "The iconic giant monster franchise that continues to awe audiences with its epic battles, destruction, and a sense of both terror and wonder. -- Metal Godzilla",
    review2: "",
    review3: "",
...
let metalgearsolid = {
    description: "Metal Gear (Japanese: メタルギア, Hepburn: Metaru Gia) is a series of techno-thriller stealth games created by Hideo Kojima. Developed and published by Konami, the first game, Metal Gear, was released in 1987 for MSX home computers. The player often takes control of a special forces operative (usually Solid Snake or Big Boss), who is assigned the task of finding the titular superweapon, Metal Gear, a bipedal walking tank with the ability to launch nuclear weapons.",
    developedby: "Konami and Kojima Productions",
    logo: "metalgearsolidlogo.png",
    review1: "One of the stealth games ever -- Snake",
    review2: "A groundbreaking video game series that masterfully combines stealth gameplay, cinematic storytelling, and complex political narratives to create an unforgettable experience. -- Revolver Ocelot",
    review3: "",
    ...
    trailer: "https://www.youtube.com/watch?v=RhseWPWYPBA",
    number: "11"
}

let furi = {
    description: "Furi is a 2016 action shoot 'em up video game developed and published by indie studio The Game Bakers available for PlayStation 4, Windows, Xbox One, Nintendo Switch, PlayStation 5, and Amazon Luna. The game takes place on a planet in a colorful, retro, science fiction setting and consists entirely of boss fights.",
    developedby: "The Game Bakers",
    logo: "furilogo.png",
    review1: "An intense and stylish boss-rush game that tests your reflexes and determination with its challenging battles and mesmerizing soundtrack. -- Every Carpenter Bunt fan",
    review2: "",
    review3: "",
...
let moastray = {
    description: "MO: Astray is a 2019 Taiwanese indie game developed by Rayark International Limited. It is a pixelated, side-scrolling, puzzle-solving action game featuring the main character MO and its special abilities. The game is loaded with bizarre enemies, threatening traps, and ingenious level designs. Elara Shelley is the main antagonist and final boss of the game. She was a research scientist for W.B. Labs that was turned into a life form made of Extremergy. Prior to her conversion, Elara was a brown-haired Caucasian woman with red glasses, usually depicted wearing a black shirt, green pants, grey shoes, and a lab coat.",
    developedby: "Rayark Inc.",
...
let gurrenlagann = {
    ...
    trailer: "https://www.youtube.com/watch?v=rAQylCHv8Cw",
    number: "16"
}
...
let va11halla = {
    ...
    trailer: "https://www.youtube.com/watch?v=7x393waFKDw",
    number: "17"
}

let katanazero = {
    description: "Katana Zero is a 2019 platform game created by the indie developer Justin Stander. Set in a dystopian metropolis, the neo-noir storyline follows Subject Zero, a katana-wielding assassin with amnesia who can slow down time and predict the future. Zero unravels his past while completing assassination contracts. Katana Zero features side-scrolling hack-and-slash gameplay in which the player attempts to kill all enemies in a level without being hit, using Zero's abilities to manipulate time, dodge attacks, and take advantage of environmental hazards. In-between levels, the story is told in sequences where the player converses with non-player characters through dialogue trees.",
    developedby: "Askiisoft",
    ...
    trailer: "https://www.youtube.com/watch?v=uo2FOBnt11o",
    number: "18"
}
...
let starbound = {
    ...
    trailer: "https://www.youtube.com/watch?v=-O6PUh3reG0",
    number: "19"
}

let planets = [
    bionicle, riskofrain, outerwilds, einhaender, ultrakill, warhammer40k, deeprockgalactic, deadspace, digimon, planetes, godzilla, metalgearsolid, furi, moastray, guiltygear, hyperlightdrifter, gurrenlagann, va11halla, katanazero, starbound
]